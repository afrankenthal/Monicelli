...
fitter::fitter(void) :
  ...
  , calibrationFitFunction_    (new TF1(calibrationFitFunctionName_, ROC::calibrationFitFunctionROOT, 0, 800000,3))
{
}
  ...
  if (histo->GetEntries() != 0)
    {
      ...
      // if (pars == 0) calibrationFitFunction_->SetParameters(400,300,0.00004,-0.1);
      if (pars == 0) calibrationFitFunction_->SetParameters(1e-5,1e-2,200,-0.1);
