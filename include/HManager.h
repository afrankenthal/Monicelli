...
class HManager : public multiProcess< HManager,std::vector<std::string> >
{
  ...
  public:
    ...
    stringVDef             makeClusterPlots2            (Event                  * theEvent                      ,
                                                         bool                   & redo                           ) ;
    stringVDef             makeTracksDistr2             (Event                  * theEvent                      ,
                                                         bool                   & redo                           ) ;
    stringVDef             makeTrackErrorsOnDUTs2       (Event                  * theEvent                      ,
                                                         bool                   & redo                           ) ;
    stringVDef             makeDUTprojections2          (Event                  * theEvent                      ,
                                                         bool                   & redo                          ,
                                                         stringVDef               DUTs                           ) ;
    stringVDef             makeMeanScatterResidual      (stringVDef               histoTypes                    , 
                                                         bool                     redo = true                    ) ;
    ...
    void                   setSubProcessFunction        (HManager_Make_function   function, 
                                                         bool                     redo = false                   ) {subProcessFunction_=function; redo_=redo;}

    stringVDef             storeCustomTObject  	        (TObject                * object                        , 
